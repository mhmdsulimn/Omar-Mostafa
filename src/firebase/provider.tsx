...
export const FirebaseProvider: React.FC<FirebaseProviderProps> = ({
  ...
  const contextValue = useMemo((): FirebaseContextState => {
    // تم تعديل الفحص ليكون "اختياري" للخدمات غير الأساسية مثل Storage لمنع تعطل المنصة
  ...
  }, [firebaseApp, firestore, auth, messaging, storage, userAuthState]);
...
export const useFirebase = (): FirebaseServicesAndUser => {
  ...
  // السماح بتشغيل التطبيق طالما الخدمات الأساسية (قاعدة البيانات والهوية) متاحة
